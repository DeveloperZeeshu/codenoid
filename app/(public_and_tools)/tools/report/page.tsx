...
import { ArrowLeft, BookOpen, ShieldAlert, Bug, Zap, Loader2, Sparkles } from 'lucide-react';
import Link from 'next/link';
import { FormEvent } from 'react';
import toast from 'react-hot-toast';

export default function BugReportPage() {
  const { input, handleInputChange, handleSubmit, setInput, completion, isLoading } = useCompletion({
    api: '/api/ai',
    streamProtocol: 'text',
    body: { type: 'report' },
    onFinish: () => {
  ...
  return (
    <div className="max-w-7xl mx-auto lg:px-6 pb-10 flex flex-col min-h-screen">
      ...
      <div className="bg-zinc-900/30 border border-zinc-800 rounded-[2.5rem] overflow-hidden grid grid-cols-1 lg:grid-cols-2 lg:h-150">

        <div className="flex flex-col border-b lg:border-b-0 lg:border-r border-zinc-800 bg-zinc-900/20 h-125 lg:h-full overflow-hidden">
        ...
        <div className="bg-zinc-950 flex flex-col h-125 lg:h-full overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar">
            <div className="px-4 lg:px-8 pb-10">
              {completion ? (
                ...
                <div className="h-full min-h-75 flex flex-col items-center justify-center text-center space-y-4 opacity-20">
                  <Bug size={40} />
